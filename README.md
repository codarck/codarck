...
🔭 Actualmente estoy aprendiendo vue para el desarrollo.
🤔 Explorar nuevas tecnologías y desarrollar soluciones de software y trucos rápidos.
🎓 Estudiar Informática, programación informática.
💼 Desarrollador full-stack y ciencia de datos.
✍️ Observar el universo y probar las últimas tendencias de diseño como pasatiempos o actividades secundarias.
😴 Creo que una siesta perfecta puede ser la solución definitiva para cualquier estrés.

<h3>🛠 Tecnologías</h3>

💻 &nbsp; Python | JavaScript | React | C++ |MERN  
🌐 &nbsp; Full-Stack | vue | HTML | CSS | JavaScript | Bootstrap | Tailwind 
🛢 &nbsp; MySQL | Postman
